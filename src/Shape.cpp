...
void Shape::loadData(float *vertexBuf, int numVertices, int *indexBuf, int numIndices) {
	posBuf.assign(vertexBuf, vertexBuf + numVertices);
	norBuf.assign(vertexBuf, vertexBuf + numVertices);
	eleBuf.assign(indexBuf, indexBuf + numIndices);
}
